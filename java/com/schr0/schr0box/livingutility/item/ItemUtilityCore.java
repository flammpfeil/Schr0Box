...
public class ItemUtilityCore extends Item
{
	...
	if (tile instanceof TileEntityChest)//instanceofでnullチェックも出来る
	{
	    ...
	    {
            //処理をメソッドに分割
            return createEntityLivingChestFromNormalChest(stack, player, world, tileChest, x, y, z);
	    }
	    ...
	    {
            //処理をメソッドに分割
            return createEntityLivingChestFromTrapChest(stack, player, world, tileChest, x, y, z);
	    }
	}
