...
import com.schr0.schr0box.livingutility.entity.chest.inventory.container.ContainerInventoryLivingChestEnder_Collect;
 ...
 */
public class GuiInventoryLivingChestEnder_Collect extends GuiContainer {
    ...
    public GuiInventoryLivingChestEnder_Collect(InventoryPlayer inventoryPlayer, EntityLivingChestEnder_Collect livingCollectChest)
    {
        super(new ContainerInventoryLivingChestEnder_Collect(inventoryPlayer, livingCollectChest));
